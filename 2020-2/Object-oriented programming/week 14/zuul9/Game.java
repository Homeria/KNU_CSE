...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        computerRoom.setItem(new Item("book", "마법에 대한 설명이 적혀 있는 오래된 책", 10));
        dongBang.setItem(new Item("portion", "먹으면 체력이 3만큼 증가하는 건강음료", 5));
        cellar.setItem(new Item("energy bar", "먹으면 체력이 3만큼 증가하는 에너지 바", 3));
