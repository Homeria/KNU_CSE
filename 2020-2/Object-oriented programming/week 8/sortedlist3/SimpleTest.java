...
public class SimpleTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("중복금지가 false이고 용량이 5인 리스트 구성");
		sortedIntList = new SortedIntList(false, 5);
		System.out.println("33, 12, -9, 1024, 1024, 1024를 차례로 add");
		for(int a : array) {
			sortedIntList.add(a);
		}
		...
		System.out.println("Uniqueness : " + sortedIntList.getUnique());
		System.out.println("setUnique(true) 테스트");
		sortedIntList.setUnique(true);
		System.out.println(sortedIntList);
		System.out.println("setUnique(false) 테스트");
		sortedIntList.setUnique(false);
		System.out.println(sortedIntList);
		System.out.println("5, -9를 차례로 add");
		sortedIntList.add(5);
		sortedIntList.add(-9);
		System.out.println(sortedIntList);
