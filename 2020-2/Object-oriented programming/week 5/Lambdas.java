...
public class Lambdas {
	...
	public void b_function1() {
		Function<String, String> func = (string) -> "(" + string + ")";
	...
	public void c_consumer1() {
		Consumer<StringBuilder> cons = (StringBuilder sb) -> sb.append("abc");
	...
	public void c_consumer2() {
		Consumer<List<String>> cons = (List<String> stringList) -> stringList.clear();
	...
	public void e_bifunction1() {
		BiFunction<String, String, String> bifunc = (string1, string2) -> string1 + string2 + string1;
