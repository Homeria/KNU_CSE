...
//		
		...
		for(int i = 0; i < dic.length; i++) {
			...
			for(int j = 0; j < tmp.size(); j++) {
				...
				System.out.println("1 dicWord = " + dicWord + ", lineWord = " + lineWord);
				
				if ((dicWord.length() == lineWord.length()) && (findMaxCount(dicWord) == findMaxCount(lineWord))) {
					System.out.println("append " + lineWord + " on candidate");
			...
			for(int p = 0; p < candidate.size(); p++) {
				...
				System.out.println("2 dicWord = " + dicWord + ", lineWord = " + lineWord);
				...
				for(int q = 0; q < dicWord.length(); q++) {
					...
					if (dicChar == lineChar) {
						System.out.println("****[set : dicWord = " + dicWord + ", target = " + lineWord + "]****");
