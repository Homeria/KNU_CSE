...
public class Crypt3 {
	...
	public static void main(String[] args) {
		...
		String halfDecrypt = halfDecrypt(list.get(0), cryptOriginal);
		System.out.println(halfDecrypt);
		halfDecrypt = halfDecrypt(list.get(1), cryptOriginal);
		System.out.println(halfDecrypt);
		System.out.println();
		String halfCrypt = halfDecrypt(list.get(0), original);
		System.out.println(halfCrypt);
		halfCrypt = halfDecrypt(list.get(1), original);
		System.out.println(halfCrypt);
		System.out.println();
		...
		list = additionalMapping(list, splitedOriginal, cryptOriginal);
